...
public class MASTAdView extends ViewGroup {
    ...
    private void internalUpdate() {
        ...
        for (Map.Entry<String, String> entry : adRequestDefaultParameters.entrySet()) {
            Log.d("Test", "Default params : " + entry.getValue() + entry.getKey());
            args.put(entry.getKey(), entry.getValue());
        }
        try {
            if (adRequest != null)
                adRequest.cancel();
            adRequest = AdRequest.create(Defaults.NETWORK_TIMEOUT_SECONDS, adNetworkURL, userAgent, args,
                    adRequestHandler);
        ...
        public void mraidResize(final Bridge bridge) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    RelativeLayout.LayoutParams webViewLayoutParams = new RelativeLayout.LayoutParams(widthPx, heightPx);
                        ...
                        public void imageReceived(ImageRequest request, Object imageObject) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    try {
                                        String insertedUrl = MediaStore.Images.Media.insertImage(getContext()
                                                .getContentResolver(), bitmap, "AdImage",
