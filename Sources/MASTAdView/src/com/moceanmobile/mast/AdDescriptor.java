...
public class AdDescriptor {
	 ...
	 * {
          ...
          "native": {
            "ver": 1,
            "link": {
              "url": "http:\/\/ads.moceanads.com\/1\/redir\/9bde02d0-6017-11e4-9df7-005056967c35\/0\/1",
              "fallback": "http:\/\/example.com\/fallback",
              "clicktrackers": [
            ...
            "assets": [
              {
                "id": 2,
                "img": {
                  "url": "http:\/\/example_320x50.png",
                  "w": 320,
                  "h": 50
                },
                "link": {
                  "url": "http:\/\/ads.moceanads.com\/1\/redir\/9bde02d0-6017-11e4-9df7-005056967c35\/1\/1",
                  "fallback": "http:\/\/example.com\/custom_fallback",
                  "clicktrackers": [
              ...
              },
              {
                ...
                "link": {
                  "url": "http:\/\/ads.moceanads.com\/1\/redir\/9bde02d0-6017-11e4-9df7-005056967c35\/2\/1"
                }
              },
              {
                "id": 4,
                ...
                "link": {
                  "url": "http:\/\/ads.moceanads.com\/1\/redir\/9bde02d0-6017-11e4-9df7-005056967c35\/3\/1"
                }
              },
              {
                "id": 6,
                ...
                "link": {
                  "url": "http:\/\/ads.moceanads.com\/1\/redir\/9bde02d0-6017-11e4-9df7-005056967c35\/4\/1"
                }
              }
            ],
            "imptrackers": [
	 ...
	 * {
          ...
          "mediation": {
            "id": 456,
            "name": "Mediation partner name as returned by the Ad Feed Partner",
            "source": "mediation",
            "data": {
              "adid": "123"
            },
            ...
            if (buff != null) {
                ...
                if (ads != null && (ad = ads.optJSONObject(0)) != null) {
                    ...
                    if ((TextUtils.equals(RESPONSE_NATIVE_STRING, type))
                            || ((TextUtils.equals(RESPONSE_THIRDPARTY_STRING, type)) && (TextUtils.equals(
                 ...
                 */
                // @formatter:off
				if ((TextUtils.equals(RESPONSE_NATIVE_STRING, type) || (TextUtils.equals(
				        RESPONSE_THIRDPARTY_STRING, type) && TextUtils.equals(RESPONSE_NATIVE_STRING,
						subType)))
						&& !TextUtils.isEmpty(clickUrl)
						&& nativeAssetList!=null && nativeAssetList.size()>0) {
					nativeAdDescriptor = new NativeAdDescriptor(type, nativeVersion,
							clickUrl,fallbackUrl,impressionTrackerStringArray,
							clickTrackersStringArray, jsTrackerString, nativeAssetList);
					...
					nativeAdDescriptor = new NativeAdDescriptor(type,
							...
							adUnitId, mediationSource, impressionTrackerStringArray,
