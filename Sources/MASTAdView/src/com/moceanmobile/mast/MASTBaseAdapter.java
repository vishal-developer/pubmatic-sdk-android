...
public abstract class MASTBaseAdapter {
     ...
     * MASTNativeAd.java and it will also set listeners to listen the events
     * from the thirdparty SDK events.
     * 
     * @param context
     * @param adDescriptor
     * @param adapterListener
     * @param mRequestedNativeAssets
     */
    protected void init(Context context, NativeAdDescriptor adDescriptor, MASTBaseAdapterListener adapterListener,
            List<AssetRequest> requestedNativeAssets) {

        mContext = context;
        mAdDescriptor = adDescriptor;
        mBaseAdapterListener = adapterListener;
        mRequestedNativeAssetsList = requestedNativeAssets;
     ...
     */
    protected static final MASTBaseAdapter getAdapterForClass(String className, Context context) {
