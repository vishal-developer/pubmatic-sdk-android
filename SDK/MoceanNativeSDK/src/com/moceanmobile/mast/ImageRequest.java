		...
		public void run() {
			try {
				...
				urlConnection.setRequestProperty(
						Defaults.HTTP_REQ_HEADER_USER_AGENT,
						userAgent);
				urlConnection.setRequestProperty(
						Defaults.HTTP_REQ_HEADER_CONNECTION,
						Defaults.HTTP_REQ_HEADER_CONNECTION_CLOSE);
				urlConnection.setDoInput(true);
				urlConnection
						.setRequestMethod(Defaults.HTTP_METHOD_GET);
