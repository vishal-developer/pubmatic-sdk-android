...
public final class NativeAdDescriptor extends AdDescriptor {
     ...
     */
    NativeAdDescriptor(String subtype, int nativeVersion2, String clickUrl, String fallbackUrl,
     ...
     * @param feedId
     */
    NativeAdDescriptor(String subtype, String creativeId, String mediation, String mediationId, String adUnitId,
